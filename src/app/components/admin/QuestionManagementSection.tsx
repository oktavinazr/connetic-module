...
export function QuestionManagementSection() {
  ...
  return (
    <div className="space-y-7">
      {/* Page header */}
      <div>
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#628ECB] mb-2">Evaluasi</p>
        <h1 className="text-3xl font-bold text-[#395886] tracking-tight mb-1">Manajemen Soal Pretest & Posttest</h1>
