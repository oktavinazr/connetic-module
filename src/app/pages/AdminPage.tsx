...
import { HasilBelajarSection, TestAnswerSection, type LessonSummary, type StudentActivitySummary } from '../components/admin/HasilBelajarSection';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
        ...
        <main className="flex-1 min-w-0">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {false && (
              <div className="space-y-6">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#628ECB] mb-2">Monitoring</p>
                  <h1 className="text-3xl font-bold text-[#395886] tracking-tight mb-1">Kelompok Belajar</h1>
